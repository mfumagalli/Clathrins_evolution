...
ll <- setdiff(ll, c("Results/Genes_allsites/CLTC.stats.txt", "Results/Genes_allsites/CLTA.stats.txt", "Results/Genes_allsites/CLTB.stats.txt", "Results/Genes_allsites/PCDHA2.stats.txt", "Results/Genes_allsites/PCDHA3.stats.txt", "Results/Genes_allsites/PCDHA4.stats.txt", "Results/Genes_allsites/PCDHA5.stats.txt", "Results/Genes_allsites/PCDHA6.stats.txt", "Results/Genes_allsites/PCDHA7.stats.txt", "Results/Genes_allsites/PCDHA8.stats.txt"))
...
plot(ctr$het[ind], ctr$FST_CEU[ind]); points(ctr$het[it], ctr$FST_CEU[it], col="red", pch=16, cex=2)

ind <- which(ctr$POP=="YRI")
it <- ind[which(ctr$name[ind]=="CLTCL1")]
plot(ctr$het[ind], ctr$FST_CHB[ind]); points(ctr$het[it], ctr$FST_CHB[it], col="red", pch=16, cex=2)
